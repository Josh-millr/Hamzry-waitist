  ...
  return (
    <PageMargin>
      ...
      <div className="grid text-start">
        ...
        <h3 className="pb-8 text-lg lg:text-2xl">Types of Data Collected</h3>
      ...
      <div className="mb-8 grid text-start">
        <p className="pb-4 text-2xl lg:text-3xl">Use of Your Personal Data</p>
        ...
        <ul class="grid list-disc gap-y-4 pl-8">
          ...
          <li>
            ...
            as a registered user. managing authority.
          </li>
          ...
          <li>
            ...
            necessary or reasonable for their implementation. uses.
          </li>
        ...
        <ul class="grid list-disc gap-y-4 pl-8">
          ...
          <li>
            ...
            for any other purpose with Your consent to Us.
          </li>
        </ul>
      </div>
      ...
      <div className="mb-8 grid text-start">
        <p className="pb-4 text-2xl lg:text-3xl">
          Retention of Your Personal Data
        </p>
      ...
      <div className="mb-8 grid text-start">
        <p className="pb-4 text-2xl lg:text-3xl">Delete Your Personal Data</p>
      ...
      <div className="mb-8 grid text-start">
        ...
        <div className="text-base">
          <div className="mb-4">
            <h4 className="mb-2 text-lg font-bold">Business Transactions</h4>
            <p>
          ...
          <div className="mb-4">
            <h4 className="mb-2 text-lg font-bold">Law enforcement</h4>
            <p>
          ...
          <div className="mb-4">
            <h4 className="mb-2 text-lg font-bold">Other legal requirements</h4>
            <p>
      ...
      {/* Children's Privacy */}
      <div className="mb-8 grid text-start">
        <p className="pb-4 text-2xl lg:text-3xl">{"Children's"} Privacy</p>
      ...
      {/* CLinks to Other Websites */}
      <div className="mb-8 grid text-start">
        <p className="pb-4 text-2xl lg:text-3xl">Links to Other Websites</p>
